---
title: シングルインスタンスでSQLiteを利用する Rails 8 アプリを Fly.io にデプロイする
date: 2025-02-23
description: シングルインスタンスでSQLiteを利用する Rails 8 アプリを Fly.io にデプロイする
iconUrl: https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Bird/Flat/bird_flat.svg
---

## シングルインスタンスでSQLiteを利用する Rails 8 アプリを Fly.io にデプロイする
